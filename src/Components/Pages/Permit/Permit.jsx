...
const Permit = () => {
      ...
      const filteredData = permitList.filter(
        (arr) =>
          ...
          arr.permit_number
            ...
            .toLowerCase()
            .includes(lowercasedValue) ||
          arr.student_name.toString().toLowerCase().includes(lowercasedValue) ||
          arr.car_type.toString().toLowerCase().includes(lowercasedValue) ||
          arr.car_color.toString().toLowerCase().includes(lowercasedValue)
      );
  ...
  return (
    <>
      <Routes>
        <Route path="/PermitsLog" element={<Permit />}></Route>
      </Routes>
                    ...
                    <div className="project-box-wrapper" key={index}>
                      <div className="project-box">
                        ...
                        <div className="project-box-content-header">
                          {item.colleage == "Faculty of Computer Science" ? (
